...
# int readArray(int A[])
#####
# reads the array into A and returns the size
# locals:
#	$t0, size of the array
#	$t1, counter for the array
#	$t2, the array pointer 
readArray:
	ori $t2, $a0, 0
	li $v0, 5
	syscall
...
.data
arraySpot: .space 1028 #store up to 1024 long array, with first word being the length
