...
// Created: 4/23/2014 8:59:09 PM

function WebTrends(){
	var that=this;
	// begin: user modifiable
	this.dcsid=(function(){var domlist="stratpre1.ic.gc.ca,epicpre.ic.gc.ca,www-dev.ic.gc.ca,www-pre.ic.gc.ca,www-uat.ic.gc.ca,www-qa.ic.gc.ca,stratdev1.ic.gc.ca,webtrends.ic.gc.ca,icweb.ic.gc.ca,wiki.ic.gc.ca,shib-dev.ic.gc.ca,shib-uat.ic.gc.ca,shib-pre.ic.gc.ca,prestratnotes.ic.gc.ca,intranet-dev.ic.gc.ca,stratuat.ic.gc.ca,intranet-uat.ic.gc.ca,stratnotes.ic.gc.ca,stratintraqa.ic.gc.ca,stratintra.ic.gc.ca,stratqa.ic.gc.ca,intranet-pre.ic.gc.ca,stratintrapre.ic.gc.ca,stratdemo.ic.gc.ca,agora-dev.ic.gc.ca,asbscr.ic.gc.ca,icintradev.ic.gc.ca,intranet.ic.gc.ca,intranet-test.ic.gc.ca,sddev.ic.gc.ca,sdqa.ic.gc.ca,pre-sd.ic.gc.ca,shib.ic.gc.ca,shib-qa.ic.gc.ca,cip-landriap.ic.gc.ca,intranet-qa.ic.gc.ca,icweb.ic.gc.ca,apcxdev.ic.gc.ca,apcxuat.ic.gc.ca,apc-cap-preprod.ic.gc.ca,devt.ccs.ic.gc.ca,dev.patents.ic.gc.ca,localhost:9080,localhost,hpvsdev232,hpvsdev232.ic.gc.ca,hpvsdev237.pre-prod.prv,hpvsdev25,eservice-dev.ic.gc.ca,eservice-uat.ic.gc.ca,eservice-qa.ic.gc.ca,hpvsdev233.ic.gc.ca,hpvsdev36.ic.gc.ca,eservice-pre.ic.gc.ca,hpvsdev238.pre-prod.prv";var doms=that.dcsSplit(domlist);var dlen=doms.length;var host=window.location.hostname.toLowerCase();for (var i=0;i<dlen;i++){if (host==doms[i]){return("dcskopf12f0ei7ounxoaa3eue_8l5l");}}return("dcs6v67hwe0ei7wsv8g9fv50d_3k6i");})();
	this.domain="wt-sdc.ic.gc.ca";
	this.timezone=-5;
	this.onsitedoms=(function(){return(window.RegExp?new RegExp("((ic|strategis|competitionbureau|bureaudelaconcurrence|feddevontario|fednor|fightspam|canadabio|reducingpaperburden|reduirepaperasserie|sme-fdi|pme-prf|ocl-cal|de-en|pma-ppm|stic-csti|crc)\.gc\.ca)|((strategis|cipo|opic|brevets-patents|corporationscanada|ito|oti|ito-oti|sitt|stit|sd|apc-cap|multimedia)\.ic\.gc\.ca)|((consumerinformation|registrarscorner|coindesregistraires)\.ca)","i"):"");})();
	this.downloadtypes="xls,xlsx,doc,docx,pdf,txt,csv,zip,ppt,pptx,avi,wmv,mov,rm,mp2,mp3,mp4,flv,swf,tar,rar,gz,mpeg,mpg,wav,wma,ai,cdr,wpd,eps,tif,tiff,epub";
	this.navigationtag="div,table";
	this.metanames="dcterms.language,dcterms.type,dcterms.subject,dcterms.issued,dcterms.modified,author,dcterms.created,dcterms.publisher,dcterms.format,site_product_code,dcterms.identifier,dc.subject,dc.date.created,dc.date.modified,dc.date.issued,review_date,dc.language,dc.publisher,dc.type,dc.format";
